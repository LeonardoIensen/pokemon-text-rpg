...
def intro():
    talk("PROF. OAK", "Hello! It's a pleasure to meet you! Welcome to the fabulous world of Pokémon!")
    ...
    talk("PROF. OAK", "Some people treat them as pets, others use them in battles.")
    talk("PROF. OAK", "Well, As for me... I study POKEMON as a profession.")
    ...
    talk("PROF. OAK", "Ah, yes... I also have a grandson. He's been your rival since you both were babies.")
    ...
    while True:
        ...
        if 0 < len(rival_name) <= 10:
            break
             ...
             narration("\n[Invalid name! It must be between 1 and 10 characters.]")
             next_dialogue()
             ask("PROF. OAK", "Erm... What was his name again?")

    talk("PROF. OAK", f"That's right! I remember now! His name is {rival_name}!")
    talk("PROF. OAK", f"{player_name}! Your own Pokémon legend is about to begin! A world of dreams and adventures awaits you! So, let's go!")
...
def start_journey(player_name, rival_name):
    ...
    talk("MOM", "Right, All boys leave home someday. It said so on TV... Oh yes. PROF. OAK wants to see you.")

    narration(f"\nCurious, {player_name} leaves home and walks through the small town of Pallet.")

    talk("PROF. OAK", "Hey! Wait! Wild Pokémon live in tall grass!")
    talk("PROF. OAK", "Without a Pokémon, it would be dangerous to go alone. Come with me to my lab.")

    narration(f"\n{player_name} accompanies PROF. OAK to his lab.")
    narration(f"\nUpon entering the lab, {player_name} finds {rival_name} waiting impatiently.")

    talk(f"{rival_name}", "Finally arrived! Gramps! I'm tired of waiting!")
    talk("PROF. OAK", "Be patient... You two will get your own Pokémon today.")
    talk("PROF. OAK", "There are three Pokémon here. They were raised especially for young trainers.")
